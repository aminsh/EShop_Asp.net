...
namespace DataAccess
{
	...
	public class DbObject
	{
        ...
        public DataSet RunQuery(string Query, string tableName, IDataParameter[] parameters)
        {
            DataSet dataSet = new DataSet();
            Connection.Open();
            SqlDataAdapter sqlDA = new SqlDataAdapter();
        ...
        public object RunQuery(string query, IDataParameter[] parameters)
        {

            Connection.Open();
            SqlCommand command = BuildQueryCommand(query, parameters);
